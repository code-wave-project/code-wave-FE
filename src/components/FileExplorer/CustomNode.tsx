...
export const CustomNode: React.FC<CustomNodeProps> = ({ node, depth, isOpen, onToggle, onDelete, onSelect }) => {
	...
	return (
		<div className={`tree-node ${node.data?.fileType}`} style={{ paddingLeft: indent }} onClick={onSelect}>
